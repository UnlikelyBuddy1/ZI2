...
## About the project
### Disclaimer
This application is not a replacement for the Zurich instruments Labone software, it is meant to be used along side it. You still have to use Labone and connect your instrument to it.
### What is it for
...
update : Zi² and its creator have been cited in the Zurich Instruments Q4/2020 News Letter in the [**User Story**](https://www.zhinst.com/others/fr/newsletter/zurich-instruments-newsletter-edition-q4-2020?utm_source=Newsletter&utm_campaign=4da786f127-nl_2020q4_en&utm_medium=email&utm_term=0_c41d39be19-4da786f127-206273749) section, there is also an [**interview**](https://www.zhinst.com/others/fr/resources/customer-interviews/david-albertini) of David ALBERTINI !
...
## Special thanks
I'd like to thank the [*INL*](https://inl.cnrs.fr/) and both of my internship tutors, David ALBERTINI david.albertini@insa-lyon.fr and Nicolas BABOUX and  for the guidance they provided in this project, as well as Mehdi ALEM mehdi.alem@zhinst.com from the Zurich instruments support team which did an amazing job of explaining how to properly use of the HF2LI programming features.
